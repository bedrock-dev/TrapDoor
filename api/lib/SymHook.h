...
namespace SymHook{
	...
	// [原型] public: struct Tick const & __ptr64 __cdecl Level::getCurrentTick(void)const __ptr64
	...
	constexpr RVA MSSYM_B1QE14getBlockEntityB1AE11BlockSourceB2AAE18QEAAPEAVBlockActorB2AAA3HHHB1AA1Z = 0x00A1D6A0;
