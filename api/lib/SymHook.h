...
namespace SymHook{
	...
	// [ԭ��] private: void __cdecl Spawner::_sendHerdEvents(struct MobSpawnHerdInfo const & __ptr64,class std::vector<class Mob * __ptr64,class std::allocator<class Mob * __ptr64> > & __ptr64)const __ptr64
	// [����] ?_sendHerdEvents@Spawner@@AEBAXAEBUMobSpawnHerdInfo@@AEAV?$vector@PEAVMob@@V?$allocator@PEAVMob@@@std@@@std@@@Z
	constexpr RVA MSSYM_B2QUE14sendHerdEventsB1AA7SpawnerB2AAE25AEBAXAEBUMobSpawnHerdInfoB2AAA4AEAVB2QDA6vectorB1AA7PEAVMobB2AAA1VB2QDA9allocatorB1AA7PEAVMobB3AAAA3stdB3AAAA3stdB3AAAA1Z = 0x01362F70;
