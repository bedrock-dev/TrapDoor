...
namespace SymHook {
    ...
    // [原型] public: virtual class Actor * __ptr64 __cdecl Level::fetchEntity(struct ActorUniqueID,bool)const __ptr64
    // [符号] ?fetchEntity@Level@@UEBAPEAVActor@@UActorUniqueID@@_N@Z
    ...
    // [原型] public: class BlockActor * __ptr64 __cdecl BlockSource::getBlockEntity(int,int,int) __ptr64
    // [符号] ?getBlockEntity@BlockSource@@QEAAPEAVBlockActor@@HHH@Z
    ...
    // [原型] public: virtual void __cdecl Level::spawnParticleEffect(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > const & __ptr64,class Vec3 const & __ptr64,class Dimension * __ptr64) __ptr64
    // [符号] ?spawnParticleEffect@Level@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVVec3@@PEAVDimension@@@Z
    constexpr RVA MSSYM_MD5_52e7de092fab8d042fb516e31fc9756f = 0x00C3AD10;
