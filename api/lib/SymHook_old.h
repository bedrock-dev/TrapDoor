...
// [原锟斤拷] public: virtual void __cdecl
...
// [原锟斤拷] void __cdecl CommandUtils::displayLocalizableMessage(bool,class
// Player & __ptr64,class std::basic_string<char,struct
...
// std::basic_string<char,struct std::char_traits<char>,class
// std::allocator<char> > > > const & __ptr64) [锟斤拷锟斤拷]
...
// [原锟斤拷] public: virtual void __cdecl ServerLevel::tick(void) __ptr64
// [锟斤拷锟斤拷] ?tick@ServerLevel@@UEAAXXZ
constexpr RVA MSSYM_B1QA4tickB1AE11ServerLevelB2AAA7UEAAXXZ = 0x00767B60;

// [原锟斤拷] public: virtual int __cdecl ServerPlayer::tickWorld(struct Tick
// const & __ptr64) __ptr64 [锟斤拷锟斤拷]
// ?tickWorld@ServerPlayer@@UEAAHAEBUTick@@@Z
constexpr RVA
    MSSYM_B1QA9tickWorldB1AE12ServerPlayerB2AAE13UEAAHAEBUTickB3AAAA1Z =
        0x00767D90;

// [原锟斤拷] public: virtual void __cdecl Dimension::tick(void) __ptr64
// [锟斤拷锟斤拷] ?tick@Dimension@@UEAAXXZ
constexpr RVA MSSYM_B1QA4tickB1AA9DimensionB2AAA7UEAAXXZ = 0x01017680;

// [原锟斤拷] public: void __cdecl LevelChunk::tick(class BlockSource &
// __ptr64,struct Tick const & __ptr64) __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: void __cdecl LevelChunk::tickBlocks(class BlockSource &
...
// [原锟斤拷] public: void __cdecl LevelChunk::tickBlockEntities(class
// BlockSource & __ptr64) __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: bool __cdecl BlockTickingQueue::tickPendingTicks(class
...
// [原锟斤拷] public: virtual void __cdecl Dimension::tickRedstone(void) __ptr64
// [锟斤拷锟斤拷] ?tickRedstone@Dimension@@UEAAXXZ
constexpr RVA MSSYM_B1QE12tickRedstoneB1AA9DimensionB2AAA7UEAAXXZ = 0x010179E0;

// [原锟斤拷] public: void __cdecl EntitySystems::tick(class EntityRegistry &
// __ptr64) __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: bool __cdecl Actor::tick(class BlockSource & __ptr64)
// __ptr64 [锟斤拷锟斤拷] ?tick@Actor@@QEAA_NAEAVBlockSource@@@Z
constexpr RVA
    MSSYM_B1QA4tickB1AA5ActorB2AAA4QEAAB1UE16NAEAVBlockSourceB3AAAA1Z =
        0x00B8C1C0;

// [原锟斤拷] public: virtual void __cdecl Actor::getDebugText(class
// std::vector<class std::basic_string<char,struct std::char_traits<char>,class
// std::allocator<char> >,class std::allocator<class
// std::basic_string<char,struct std::char_traits<char>,class
// std::allocator<char> > > > & __ptr64) __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: virtual class Vec3 const & __ptr64 __cdecl
// Actor::getPos(void)const __ptr64 [锟斤拷锟斤拷]
// ?getPos@Actor@@UEBAAEBVVec3@@XZ
constexpr RVA MSSYM_B1QA6getPosB1AA5ActorB2AAE12UEBAAEBVVec3B2AAA2XZ =
    0x00B6AD90;

// [原锟斤拷] public: virtual bool __cdecl Player::attack(class Actor & __ptr64)
// __ptr64 [锟斤拷锟斤拷] ?attack@Player@@UEAA_NAEAVActor@@@Z
constexpr RVA MSSYM_B1QA6attackB1AA6PlayerB2AAA4UEAAB1UE10NAEAVActorB3AAAA1Z =
    0x00BB8AC0;

// [原锟斤拷] public: void __cdecl Explosion::explode(void) __ptr64
// [锟斤拷锟斤拷] ?explode@Explosion@@QEAAXXZ
...
// [原锟斤拷] public: class Vec3 __cdecl Actor::getViewVector(float)const
// __ptr64 [锟斤拷锟斤拷] ?getViewVector@Actor@@QEBA?AVVec3@@M@Z
constexpr RVA
...
// [原锟斤拷] public: virtual void __cdecl ServerPlayer::setPlayerGameType(enum
// GameType) __ptr64 [锟斤拷锟斤拷]
...
constexpr RVA
    MSSYM_B1QE17setPlayerGameTypeB1AE12ServerPlayerB2AAE15UEAAXW4GameTypeB3AAAA1Z =
        0x00765070;
// [原锟斤拷] public: class Block const & __ptr64 __cdecl
// BlockSource::getBlock(class BlockPos const & __ptr64)const __ptr64
// [锟斤拷锟斤拷] ?getBlock@BlockSource@@QEBAAEBVBlock@@AEBVBlockPos@@@Z
constexpr RVA
    MSSYM_B1QA8getBlockB1AE11BlockSourceB2AAE13QEBAAEBVBlockB2AAE12AEBVBlockPosB3AAAA1Z =
        0x00F9E5C0;

// [原锟斤拷] public: bool __cdecl BlockSource::setBlock(int,int,int,class Block
// const & __ptr64,int) __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: bool __cdecl BlockSource::setBlock(class BlockPos const &
...
// [原锟斤拷] public: void __cdecl BlockSource::updateNeighborsAt(class BlockPos
// const & __ptr64) __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: virtual enum EventResult __cdecl
...
// [原锟斤拷] public: virtual class AABB const & __ptr64 __cdecl
// BlockLegacy::getOutline(class BlockSource & __ptr64,class BlockPos const &
// __ptr64,class AABB & __ptr64)const __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: void __cdecl BlockLegacy::getDebugText(class
// std::vector<class std::basic_string<char,struct std::char_traits<char>,class
// std::allocator<char> >,class std::allocator<class
// std::basic_string<char,struct std::char_traits<char>,class
...
// [原锟斤拷] public: virtual void __cdecl BlockActor::getDebugText(class
// std::vector<class std::basic_string<char,struct std::char_traits<char>,class
// std::allocator<char> >,class std::allocator<class
// std::basic_string<char,struct std::char_traits<char>,class
...
// [锟斤拷锟斤拷] ?tryGetStateFromLegacyData@BlockLegacy@@QEBAPEBVBlock@@G@Z
constexpr RVA
    MSSYM_B1QE25tryGetStateFromLegacyDataB1AE11BlockLegacyB2AAE13QEBAPEBVBlockB2AAA1GB1AA1Z =
        0x010BE0B0;

// [原锟斤拷] public: class Biome & __ptr64 __cdecl BlockSource::getBiome(class
// BlockPos const & __ptr64) __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: void __cdecl Village::tick(struct Tick,class BlockSource &
// __ptr64) __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: float __cdecl Village::getApproximateRadius(void)const
// __ptr64 [锟斤拷锟斤拷] ?getApproximateRadius@Village@@QEBAMXZ
constexpr RVA MSSYM_B1QE20getApproximateRadiusB1AA7VillageB2AAA7QEBAMXZ =
    0x00D71E50;

// [原锟斤拷] public: unsigned __int64 __cdecl
// Village::getBedPOICount(void)const __ptr64 [锟斤拷锟斤拷]
// ?getBedPOICount@Village@@QEBA_KXZ
constexpr RVA MSSYM_B1QE14getBedPOICountB1AA7VillageB2AAA4QEBAB1UA3KXZ =
    0x00D71FC0;

// [原锟斤拷] public: virtual class MobSpawnerData const * __ptr64 __cdecl
// BlockLegacy::getMobToSpawn(class SpawnConditions const & __ptr64,class
// BlockSource & __ptr64)const __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: static bool __cdecl Spawner::findNextSpawnBlockUnder(class
// BlockSource const & __ptr64,class BlockPos & __ptr64,enum MaterialType,enum
// SpawnBlockRequirements) [锟斤拷锟斤拷]
...
// [原锟斤拷] public: virtual void __cdecl HopperBlockActor::setItem(int,class
// ItemStack const & __ptr64) __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: bool __cdecl Item::useOn(class ItemStack & __ptr64,class
// Actor & __ptr64,int,int,int,unsigned char,float,float,float)const __ptr64
// [锟斤拷锟斤拷] ?useOn@Item@@QEBA_NAEAVItemStack@@AEAVActor@@HHHEMMM@Z
constexpr RVA
    MSSYM_B1QA5useOnB1AA4ItemB2AAA4QEBAB1UE14NAEAVItemStackB2AAA9AEAVActorB2AAA7HHHEMMMB1AA1Z =
        0x00E42C00;

// [原锟斤拷] public: class BaseCircuitComponent * __ptr64 __cdecl
...
// [原锟斤拷] public: enum VanillaBiomeTypes __cdecl
// Biome::getBiomeType(void)const __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: unsigned __int64 __cdecl
// NetworkIdentifier::getHash(void)const __ptr64 [锟斤拷锟斤拷]
// ?getHash@NetworkIdentifier@@QEBA_KXZ
constexpr RVA MSSYM_B1QA7getHashB1AE17NetworkIdentifierB2AAA4QEBAB1UA3KXZ =
    0x00684650;

// [原锟斤拷] public: virtual void __cdecl ServerNetworkHandler::handle(class
...
// [原锟斤拷] public: void __cdecl CommandRegistry::registerCommand(class
// std::basic_string<char,struct std::char_traits<char>,class
...
// [原锟斤拷] public: virtual enum CommandPermissionLevel __cdecl
// Player::getCommandPermissionLevel(void)const __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: class PlayerInventory & __ptr64 __cdecl
// Player::getSupplies(void) __ptr64 [锟斤拷锟斤拷]
// ?getSupplies@Player@@QEAAAEAVPlayerInventory@@XZ
constexpr RVA
    MSSYM_B1QE11getSuppliesB1AA6PlayerB2AAE23QEAAAEAVPlayerInventoryB2AAA2XZ =
        0x00BC0600;

// [原锟斤拷] public: virtual void __cdecl ItemStackBase::setNull(void) __ptr64
// [锟斤拷锟斤拷] ?setNull@ItemStackBase@@UEAAXXZ
constexpr RVA MSSYM_B1QA7setNullB1AE13ItemStackBaseB2AAA7UEAAXXZ = 0x00C53AA0;

// [原锟斤拷] public: struct Brightness __cdecl
// BlockSource::getRawBrightness(class BlockPos const & __ptr64,bool,bool)const
// __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: class Material const & __ptr64 __cdecl
// BlockSource::getMaterial(int,int,int)const __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: class DwellerComponent * __ptr64 __cdecl
// Actor::tryGetComponent<class DwellerComponent>(void) __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] public: class BlockPos __cdecl
...
// [原锟斤拷] public: static void __cdecl BlockTypeRegistry::forEachBlock(class
...
// [原锟斤拷] private: void __cdecl CircuitSceneGraph::removeComponent(class
// BlockPos const & __ptr64) __ptr64 [锟斤拷锟斤拷]
...
// [原锟斤拷] private: void __cdecl CircuitSceneGraph::processPendingAdds(void)
// __ptr64 [锟斤拷锟斤拷] ?processPendingAdds@CircuitSceneGraph@@AEAAXXZ
constexpr RVA
...
// [原锟斤拷] private: bool __cdecl SPSCQueue<class
// std::basic_string<char,struct std::char_traits<char>,class
// std::allocator<char> >,512>::inner_enqueue<0,class
// std::basic_string<char,struct std::char_traits<char>,class
// std::allocator<char> > const & __ptr64>(class std::basic_string<char,struct
// std::char_traits<char>,class std::allocator<char> > const & __ptr64) __ptr64
// [锟斤拷锟斤拷]
