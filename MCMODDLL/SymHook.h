...
namespace SymHook{
	...
	// [???] public: virtual void __cdecl MinecraftEventing::fireEventPlayerMessageChat(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > const & __ptr64,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > const & __ptr64) __ptr64
	...
	// [???] public: void __cdecl Level::spawnParticleEffect(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > const & __ptr64,class Vec3 const & __ptr64,class Dimension * __ptr64) __ptr64
	// [????] ?spawnParticleEffect@Level@@QEAAXA¡ì2EBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVVec3@@PEAVDimension@@@Z
	...
	// [???] public: virtual void __cdecl Level::tick(void) __ptr64
	// [????] ?tick@Level@@UEAAXXZ
	...
	// [???] public: void __cdecl Spawner::tick(class BlockSource & __ptr64,class LevelChunk const & __ptr64) __ptr64
	...
	// [???] public: virtual bool __cdecl Actor::attack(class Actor & __ptr64) __ptr64
	// [????] ?attack@Actor@@UEAA_NAEAV1@@Z
	constexpr RVA MSSYM_B1QA6attackB1AA5ActorB2AAA4UEAAB1UA6NAEAV1B2AAA1Z = 0x0054D230;

	// [???] public: virtual bool __cdecl Player::attack(class Actor & __ptr64) __ptr64
	...
	// [???] protected: void __cdecl Actor::_refreshAABB(void) __ptr64
	// [????] ?_refreshAABB@Actor@@IEAAXXZ
	constexpr RVA MSSYM_B2QUE11refreshAABBB1AA5ActorB2AAA7IEAAXXZ = 0x00554F40;

	// [???] private: virtual bool __cdecl DyePowderItem::_useOn(class ItemStack & __ptr64,class Actor & __ptr64,class BlockPos,unsigned char,float,float,float)const __ptr64
	...
	// [???] private: virtual bool __cdecl RedStoneDustItem::_useOn(class ItemStack & __ptr64,class Actor & __ptr64,class BlockPos,unsigned char,float,float,float)const __ptr64
	...
	// [???] public: class Block const & __ptr64 __cdecl BlockSource::getBlock(int,int,int)const __ptr64
	...
	// [???] private: virtual bool __cdecl ShovelItem::_useOn(class ItemStack & __ptr64,class Actor & __ptr64,class BlockPos,unsigned char,float,float,float)const __ptr64
	...
	// [???] public: virtual void __cdecl SpongeBlock::onPlace(class BlockSource & __ptr64,class BlockPos const & __ptr64)const __ptr64
	...
	// [???] public: virtual void __cdecl VillagerV2::buildDebugInfo(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > & __ptr64)const __ptr64
	...
	// [???] public: class Mob * __ptr64 __cdecl Spawner::spawnMob(class BlockSource & __ptr64,struct ActorDefinitionIdentifier const & __ptr64,class Actor * __ptr64,class Vec3 const & __ptr64,bool,bool,bool) __ptr64
